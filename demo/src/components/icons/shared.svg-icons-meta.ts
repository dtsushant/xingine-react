...
export const lightModeIcon: IconMeta = {
  svg: {
    svg: `<svg
                          class="w-6 h-6"
                          fill="none"
...
export const homeIcon: IconMeta = {
  svg: {
...
export const usersIcon: IconMeta = {
  svg: {
    svg: `<svg class="w-5 h-5 ant-menu-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const analyticsIcon: IconMeta = {
  svg: {
    svg: `<svg class="w-5 h-5 ant-menu-item-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const settingsIcon: IconMeta = {
  svg: {
...
export const stateManagementIcon: IconMeta = {
  svg: {
    svg: `<svg class="w-5 h-5 ant-menu-item-icon" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
