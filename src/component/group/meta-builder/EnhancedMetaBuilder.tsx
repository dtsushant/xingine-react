...
import { Row, Col, Card, Button, Space, message, Modal, Tabs } from 'antd';
import { SaveOutlined, DownloadOutlined, ClearOutlined, CopyOutlined, BranchesOutlined } from '@ant-design/icons';
import { LayoutComponentDetail } from 'xingine';
import { MetaBuilderForm } from './MetaBuilderForm';
import { EnhancedMetaBuilderForm } from './EnhancedMetaBuilderForm';
import { LivePreviewWindow } from './LivePreviewWindow';

interface EnhancedMetaBuilderProps {
...
export const EnhancedMetaBuilder: React.FC<EnhancedMetaBuilderProps> = ({
  onSave,
  onLoad,
  initialData,
  mode = 'advanced'
  ...
  const [builderMode, setBuilderMode] = useState<'simple' | 'advanced'>(mode);

  // Handle changes from either form
  ...
  // Load sample nested component
  const loadSampleNestedComponent = useCallback(() => {
    const sampleNested: LayoutComponentDetail = {
      meta: {
          ...
          children: [
            {
              meta: {
                ...
                properties: {
                  level: 2,
                  content: 'Sample Nested Component'
                }
              }
            },
            {
                  ...
                  children: [
                    {
                      meta: {
                        ...
                        properties: {
                          content: 'This is nested text inside a card'
                        }
                      }
                    },
                    {
            ...
            },
            {
              meta: {
                ...
                properties: {
                  condition: { type: 'simple', expression: 'true' },
                  trueComponent: {
                    meta: {
                      component: 'TextRenderer',
                      properties: {
                        content: 'This shows when condition is true'
                      }
                    }
                  },
                  falseComponent: {
                    meta: {
                      component: 'TextRenderer',
                      properties: {
                        content: 'This shows when condition is false'
                      }
                    }
                  }
                }
    ...
    setCurrentLayoutComponent(sampleNested);
    message.success('Sample nested component loaded!');
  }, []);
    ...
    <div style={{ height: '100vh', padding: '16px', backgroundColor: '#f5f5f5' }}>
      ...
      <Card size="small" style={{ marginBottom: '16px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <h2 style={{ margin: 0 }}>Enhanced LayoutComponentDetail Meta Builder</h2>
            <p style={{ margin: 0, color: '#666' }}>
              Build and preview nested LayoutComponentDetail JSON configurations with live validation and editable JSON
            </p>
          </div>
          ...
          <Space>
            ...
            <Button
              ...
              onClick={loadSampleNestedComponent}
            >
              Load Sample
            </Button>
      ...
      <Card size="small" style={{ marginBottom: '16px' }}>
        <Tabs
          ...
          items={[
            ...
            {
              key: 'advanced',
              label: 'Advanced Builder (Nested Support)'
            }
          ]}
        />
      </Card>
      ...
      "children": [
        {
          "meta": {
            "component": "TextRenderer",
            "properties": {
              "content": "Nested component example"
            }
          }
        }
      ]
